...
| Model              | Weights                                                                                                                    | Size    |
| ------------------ | -------------------------------------------------------------------------------------------------------------------------- | ------- |
| ResNet-18          | [resnet18.onnx](https://github.com/yakhyo/head-pose-estimation/releases/download/v0.0.1/resnet18.onnx)                    | 43 MB   |
| ResNet-34          | [resnet34.onnx](https://github.com/yakhyo/head-pose-estimation/releases/download/v0.0.1/resnet34.onnx)                    | 81 MB   |
| ResNet-50          | [resnet50.onnx](https://github.com/yakhyo/head-pose-estimation/releases/download/v0.0.1/resnet50.onnx)                    | 90 MB   |
| MobileNet V2       | [mobilenetv2.onnx](https://github.com/yakhyo/head-pose-estimation/releases/download/v0.0.1/mobilenetv2.onnx)              | 8.5 MB  |
| MobileNet V3 small | [mobilenetv3_small.onnx](https://github.com/yakhyo/head-pose-estimation/releases/download/v0.0.1/mobilenetv3_small.onnx)  | 5.8 MB  |
| MobileNet V3 large | [mobilenetv3_large.onnx](https://github.com/yakhyo/head-pose-estimation/releases/download/v0.0.1/mobilenetv3_large.onnx)  | 16 MB   |
